...
class Booking(models.Model):
    ...
    description = models.CharField(max_length=255,verbose_name="Додаткова інформація",null=True,default=None,blank=True)
    reason = models.CharField(max_length=255,verbose_name="Інформація від адміністратора/модератора",null=True,default=None,blank=True)
